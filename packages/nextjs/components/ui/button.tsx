...
// Minimal Slot implementation to avoid extra dependency
const Slot = React.forwardRef<any, { children: React.ReactElement } & Record<string, any>>(
  ({ children, ...props }, ref) => {
    return React.cloneElement(children as any, { ...(props as any), ref } as any);
  },
);
